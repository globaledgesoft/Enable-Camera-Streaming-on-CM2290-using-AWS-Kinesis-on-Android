package com.kvstream.streamvideo.demo.webfrag;
...
import com.kvstream.streamvideo.demo.activity.SecondActivity;
import com.kvstream.streamvideo.demo.activity.WebRtcActivity;
...
public class WebRtcConfiguration extends Fragment {
    private static final String TAG = WebRtcConfiguration.class.getSimpleName();
    ...
    private SecondActivity navActivity;

    public static WebRtcConfiguration newInstance(SecondActivity navActivity) {
        WebRtcConfiguration s = new WebRtcConfiguration();
    ...
    private void setRegionFromCognito() {
        String region = WebRtcMain.getRegion();
        if (region != null) {
    ...
    private AWSKinesisVideoClient getAwsKinesisVideoClient(final String region) {
        final AWSKinesisVideoClient awsKinesisVideoClient = new AWSKinesisVideoClient(
                WebRtcMain.getCredentialsProvider().getCredentials());
    ...
    static class UpdateSignalingChannelInfoTask extends AsyncTask<Object, String, String> {
        final WeakReference<WebRtcConfiguration> mFragment;

        UpdateSignalingChannelInfoTask(final WebRtcConfiguration fragment) {
